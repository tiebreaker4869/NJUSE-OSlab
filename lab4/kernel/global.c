...
PUBLIC	TASK	task_table[NR_TASKS] = {{PrinterA, STACK_SIZE_A, "PrinterA"},
					{ReaderB, STACK_SIZE_B, "ReaderB"},
					{ReaderC, STACK_SIZE_C, "ReaderC"},
                    {ReaderD, STACK_SIZE_D, "ReaderD"},
                    {WriterE, STACK_SIZE_E, "WriterE"},
                    {WriterF, STACK_SIZE_F, "WriterF"}};
